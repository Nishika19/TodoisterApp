...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder>  {
    ...
    public void onBindViewHolder(@NonNull RecyclerViewAdapter.ViewHolder holder, int position) {
        ...
        ColorStateList colorStateList = new ColorStateList(new int[][]{
                ...
                Color.LTGRAY,
                Utils.setPriorityColor(task)
        });

        holder.task.setText(task.getTask());
        holder.todayChip.setText(formatted);
        holder.todayChip.setTextColor(Utils.setPriorityColor(task));
        holder.todayChip.setChipIconTint(colorStateList);
        holder.radioButton.setButtonTintList(colorStateList);
        holder.task.setTextColor(Utils.setPriorityColor(task));
...
//            this.onTaskClickListener = onTaskClickListener;
        ...
        public void onClick(View v) {
            ...
            if (id == R.id.todo_row_layout) {
                onTaskClickListener.onTaskCLick(getAdapterPosition(), currTask);
            } else if (id == R.id.todo_radio_button) {
                onTaskClickListener.onRadioClick(getAdapterPosition());
            }
        }
    }
}
